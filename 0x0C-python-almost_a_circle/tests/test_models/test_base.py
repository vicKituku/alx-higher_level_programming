...
class TestBaseToJSONString(unittest.TestCase):
    ...
    def test_to_json_string_rectangle_type(self):
        rect = Rectangle(5, 10, 3, 7, 9)
        self.assertEqual(str, type(Base.to_json_string([rect.to_dictionary()])))

    def test_to_json_string_rectangle_one_dict(self):
        rect = Rectangle(5, 10, 3, 7, 9)
        self.assertFalse(len(Base.to_json_string([rect.to_dictionary()])) == 52)

    def test_to_json_string_rectangle_two_dicts(self):
        rect1 = Rectangle(2, 3, 1, 5, 8)
        rect2 = Rectangle(7, 8, 3, 2, 1)
...
class TestBaseFromJsonString(unittest.TestCase):
    ...
    def test_from_json_string_type_rectangle(self):
        list_input = [{"id": 1, "width": 10, "height": 4}]
        json_list_input = Rectangle.to_json_string(list_input)
        list_output = Rectangle.from_json_string(json_list_input)
        self.assertEqual(list, type(list_output))

    def test_from_json_string_one_rectangle(self):
        list_input = [{"id": 1, "width": 10, "height": 4, "x": 7}]
        json_list_input = Rectangle.to_json_string(list_input)
        list_output = Rectangle.from_json_string(json_list_input)
    ...
    def test_from_json_string_two_rectangles(self):
        list_input = [
            {"id": 1, "width": 10, "height": 4, "x": 7, "y": 8},
            {"id": 2, "width": 5, "height": 2, "x": 1, "y": 3},
        ]
        json_list_input = Rectangle.to_json_string(list_input)
        list_output = Rectangle.from_json_string(json_list_input)
        self.assertEqual(list_input, list_output)
...
class TestBase_create(unittest.TestCase):
    ...
    def test_create_rectangle_original(self):
        r1 = Rectangle(4, 6, 2, 3, 8)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self.assertEqual("[Rectangle] (8) 2/3 - 4/6", str(r1))

    def test_create_rectangle_new(self):
        r1 = Rectangle(4, 6, 2, 3, 8)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self.assertEqual("[Rectangle] (8) 2/3 - 4/6", str(r2))
    ...
    def test_create_square_original(self):
        ...
        self.assertEqual("[Square] (8) 7/2 - 5", str(s1))

    def test_create_square_new(self):
        s1 = Square(5, 7, 2, 8)
        s1_dictionary = s1.to_dictionary()
        s2 = Square.create(**s1_dictionary)
        self.assertEqual("[Square] (8) 7/2 - 5", str(s2))
...
class TestBase_save_to_file_csv(unittest.TestCase):
    ...
    def test_save_to_file_csv_one_rectangle(self):
        r = Rectangle(4, 6, 8, 2, 10)
        Rectangle.save_to_file_csv([r])
        with open("Rectangle.csv", "r") as f:
            self.assertTrue("10,4,6,8,2", f.read())

    def test_save_to_file_csv_two_rectangles(self):
        r1 = Rectangle(4, 6, 8, 2, 10)
        r2 = Rectangle(2, 3, 1, 5, 7)
        Rectangle.save_to_file_csv([r1, r2])
        with open("Rectangle.csv", "r") as f:
            self.assertTrue("10,4,6,8,2\n7,2,3,1,5", f.read())

    def test_save_to_file_csv_one_square(self):
        s = Square(4, 6, 8, 10)
        Square.save_to_file_csv([s])
        with open("Square.csv", "r") as f:
            self.assertTrue("10,4,6,8", f.read())
